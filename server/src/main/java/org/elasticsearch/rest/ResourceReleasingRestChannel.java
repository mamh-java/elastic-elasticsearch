...
public final class ResourceReleasingRestChannel extends DelegatingRestChannel {

    private final ThreadContext threadContext;

    public ResourceReleasingRestChannel(RestChannel delegate, ThreadContext threadContext) {
        super(delegate);
    ...
    public void sendResponse(RestResponse response) {
        Releasable toRelease = collectTransientReleasables(threadContext);
        if (toRelease != null) {
    ...
    @Nullable
    private static Releasable collectTransientReleasables(ThreadContext threadContext) {
