...
public class MetadataMigrateToDataStreamService {
    ...
    static ClusterState migrateToDataStream(
        ...
        return createDataStream(metadataCreateIndexService, currentState, req, backingIndices, currentState.metadata().index(writeIndex), DesiredBalanceShardsAllocator.REMOVE_ME);
    }
