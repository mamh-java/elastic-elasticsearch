...
public class MvRLikeErrorTests extends ErrorsForCasesWithoutExamplesTestCase {
    ...
    protected List<TestCaseSupplier> cases() {
        ...
        return paramsToSuppliers(MvRLikeTests.parameters());
    }
    ...
    /**
     * Mirrors {@link MvRLike}'s resolveType: both arguments must be string types, except that a null-typed field
