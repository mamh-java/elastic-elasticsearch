 ...
 * <p>
 * The dual of {@link SemiJoin}: it shares the {@link SubqueryHashJoin} dedup pipeline and only flips the hooks that distinguish
 ...
 */
public class AntiJoin extends SubqueryHashJoin {
