 ...
 */
public final class TransportPutNamedCredentialAction extends TransportAction<PutNamedCredentialAction.Request, AcknowledgedResponse> {
    ...
    @Override
    protected void doExecute(Task task, PutNamedCredentialAction.Request request, ActionListener<AcknowledgedResponse> listener) {
        namedCredentialsService.putCredential(request, listener.map(created -> AcknowledgedResponse.TRUE));
    }
}
